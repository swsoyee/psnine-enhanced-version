    ...
    function onDOMContentReady() { // run when DOM is loaded
        ...
        */
        ...
        const addTrophyPieChart = () => {
            ...
            // 插入页面
            $('.box.pd10').append(
                `<${$('span.pf_ps5').length > 0 ? "p style=\"padding-bottom: 40px\"" : "p"}></p><div id="trophyRatioChart" align="left"></div>`
            );
        ...
        function showCriticAverage() {
            if (window.location.href.match(/psngame\/[1-9][0-9]+\/comment/)) {
                ...
                psnine_stats.append(`<em>&nbsp<span class="alert-success pd5" align="right">均分 ${score_average}</span></em><${$('span.pf_ps5').length > 0 ? "p style=\"padding-bottom: 40px\"" : "p"}/>`);
                score_axis = [];
